...
class Grid:
    ...
    def strike(self, cross):
        fnt = pygame.font.SysFont("comicsans", 40,bold=True)
        if cross:
            text = fnt.render("X ", True, (255, 0, 0))
        else:
            text = fnt.render("Noicee..!!", True, (0, 255, 0))
...
def main():
    ...
    while run:
        ...
        board.redraw_window(play_time, strikes)
        pygame.display.update()
